...
const $article = $('<article>').attr('id', 'article')
...
// 1. create a 'ul'
const $theHobbits = $('<ul>').addClass('the-hobbits')
...
for (i = 0; i < hobbits.length; i++) {
   ...
   $theHobbits.append($li)
    $('#The-Shire').append($theHobbits)
...
$('$theHobbits').eq([0]).append($theRing)
...
const $mordor = $('<ul>').addClass('mordor');
...
const $aside = $('<aside>').addClass('aside');
$middleEarth.append($aside);
  // 2. display an unordered list of buddies in the aside
  // 3. give each of the buddies a class of "buddy"

const $buddies = $('<ul>').addClass('buddies');
const $buddy = $('li').text(buddies[i]).addClass('buddy');
...
$theHobbits.detach().append(lands[1])
};
